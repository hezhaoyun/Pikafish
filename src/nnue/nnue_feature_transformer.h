...
template<Pikafish::Eval::NNUE::IndexType TransformedFeatureDimensions>
struct std::hash<Pikafish::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>> {
    std::size_t
    operator()(const Pikafish::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>& ft)
      const noexcept {
